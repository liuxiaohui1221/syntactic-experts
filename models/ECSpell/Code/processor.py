...
from models.ECSpell.Code.common_utils import dump_json, load_json, read_table_file, is_chinese_char, read_tagging_data
...
if __name__ == "__main__":
    ...
    string, _ = read_tagging_data(["../Data/traintest/preliminary_val_ecsspell.txt"])
