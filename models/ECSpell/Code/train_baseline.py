...
def main():
    ...
    group_data.add_argument(
        "--train_files", default="data/traintest/electra_base_chinese/preliminary_extend_train_ecsspell.txt", help="train files, split by \";\"")
    group_data.add_argument(
        "--val_files", default="data/traintest/electra_base_chinese/preliminary_val_ecsspell.txt", help="evaluation files, split by \";\"")
    group_data.add_argument(
    ...
    group_data.add_argument("--checkpoint_index", default=0, type=int, help="checkpoint index")
    ...
    if args.load_pretrain_checkpoint:
        ...
        if args.checkpoint_index:
            ...
            checkpoint_file = os.path.join(args.load_pretrain_checkpoint, "results", f"checkpoint",
                                           "pytorch_model.bin")
