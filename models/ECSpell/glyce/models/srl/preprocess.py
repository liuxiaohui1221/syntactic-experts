...
def make_dataset():
    ...
    raw_train_file = os.path.join(base_path,'conll2009-eng/CoNLL2009-ST-English-preliminary_extend_train_ecsspell.txt')
    ...
    # because the train and dev file is with full format, wo just copy them
    raw_train_file = os.path.join(base_path,'CoNLL2009-ST-Chinese-train/CoNLL2009-ST-Chinese-preliminary_extend_train_ecsspell.txt')
