...
# correct= correctorV3.CorrectorV3('../new_model/ctc_2022Y07M22D23H/epoch2,step1,testf1_39_94%,devf1_39_94%')
correct = corrector.Corrector('../model/ctc_2022Y07M24D05H/epoch2,step1,testf1_36_78%,devf1_36_78%')
submit = []
idx=0
...
def replaceAndCheckAgain(source,tuple4):
    ...
    corrected_sent=correct(new_target)
