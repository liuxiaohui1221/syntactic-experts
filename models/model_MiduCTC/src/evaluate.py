import json
from models.model_MiduCTC.src.corrector import Corrector
from models.model_MiduCTC.src.metric import final_f1_score


def evaluate(in_model_dir,json_data_file, log_fp='./logs/f1_score.logs'):
