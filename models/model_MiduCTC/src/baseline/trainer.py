...
from models.model_MiduCTC.src import logger
from models.model_MiduCTC.src.baseline.datasetV2 import DatasetCTCV2
from models.model_MiduCTC.src.baseline.datasetV3 import DatasetCTCV3
from models.model_MiduCTC.src.baseline.datasetV4 import DatasetCTCV4
from models.model_MiduCTC.src.baseline.dataset_base import DatasetCTC
...
from models.model_MiduCTC.src.metric import ctc_f1
...
class TrainerCtc:
    def __init__(self,
                 ...
                 early_stop_times: Optional[int] = 1000,
        ...
        self.ctc_label_vocab_dir = os.path.join(get_project_path(),ctc_label_vocab_dir)
        ...
        self.choose_data_mode = choose_data_mode
        print("Choose data mode:",choose_data_mode)
    ...
    def load_data(self) -> List[DataLoader]:
        ...
        elif self.choose_data_mode=='V2':
            train_ds = DatasetCTCV2(
                in_model_dir=self.in_model_dir,
                src_texts=train_src_texts,
                trg_texts=train_trg_texts,
                max_seq_len=self.max_seq_len,
            )
        elif self.choose_data_mode == 'V3':
            train_ds = DatasetCTCV3(
                in_model_dir=self.in_model_dir,
                src_texts=train_src_texts,
                trg_texts=train_trg_texts,
                max_seq_len=self.max_seq_len,
            )
        elif self.choose_data_mode == 'V4':
            train_ds = DatasetCTCV4(
                in_model_dir=self.in_model_dir,
                src_texts=train_src_texts,
                trg_texts=train_trg_texts,
                max_seq_len=self.max_seq_len,
