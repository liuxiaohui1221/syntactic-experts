...
class DatasetCTCV3(Dataset):
    ...
    def __init__(self,
        ...
        """
        super(DatasetCTCV3, self).__init__()
    ...
    def parse_item(self, src, trg):
        ...
        src, trg = src[:max_valid_len], trg[:max_valid_len]
        ...
        inputs['attention_mask'] = tempAttention.tolist()
        ...
        # 词性加入比较
        trg_property_ids, trg_prop, trg_e, trg_at = self.convert_word_to_property(trg, trg_end_pos)
