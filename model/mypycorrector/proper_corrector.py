...
from model.mypycorrector import config
...
from model.mypycorrector.utils.math_utils import edit_distance
from model.mypycorrector.utils.ngram_util import NgramUtil
from model.mypycorrector.utils.text_utils import is_chinese
from model.mypycorrector.utils.tokenizer import segment, split_2_short_text
                    ...
                    for name in names_list:
                        ...
                        if self.get_word_similarity_score(cur_item, name) > sim_threshold:
                            if cur_item != name:
                                ...
                                print("Find sim word :", cur_item, name,
                                      self.get_word_similarity_score(cur_item, name))
                                flag=True
                                break
            text_new = sentence
